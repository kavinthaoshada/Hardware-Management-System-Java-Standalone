...
public class CategoryRegistration extends javax.swing.JDialog {
    ...
    public CategoryRegistration(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        this.pr1 = (ProductRegistration1)parent;
        initComponents();
        loadCategory();
    }
    
        ProductRegistration pr;
    public CategoryRegistration(ProductRegistration parent) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(name.isEmpty()){
            JOptionPane.showMessageDialog(this, "please enter categoty name", "warning", JOptionPane.WARNING_MESSAGE);
        }else{
            try{
                ResultSet rs = MySQL.search("SELECT * FROM `category` WHERE `name`='"+name+"'");
                
                if(rs.next()){
                    JOptionPane.showMessageDialog(this, "category name alreay exist", "warning", JOptionPane.WARNING_MESSAGE);
                }else{
